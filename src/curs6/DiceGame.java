 ...
 * 2. daca userul da in total : 7, 11 --> castiga jocul (printam un mesaj)
 * 3. daca userul da in total : 3, 10 --> automat se repeta aruncarea
 * 4. daca da oricare alta varianta decat cele de mai sus, il intrebam daca vrea
 * sa mai dea inca o data. Raspunsul va fi de data type boolean : True sau False
